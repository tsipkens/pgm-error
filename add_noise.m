...
% ADD_NOISE  Simulates signal with Poisson, Gaussian, and shot-to-shot s errors. 
% 
...
% 
% OUTPUTS:  s - set of corrupted signals, with error added
...
function [s, s_ave, s_std, s_tilde] = ...
    add_noise(s_bar, tau, theta, gamma, nn)
